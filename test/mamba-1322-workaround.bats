setup_file() {
    ...
    docker build --quiet \
                 ...
                 "--tag=${MICROMAMBA_IMAGE}-mamba-1322-workaround" \
...
@test "docker run --rm ${MICROMAMBA_IMAGE}-mamba-1322-workaround echo squeamish ossifrage" {
    run docker run --rm "${MICROMAMBA_IMAGE}-mamba-1322-workaround" echo squeamish ossifrage
